...
namespace Framebook.Domain.Services
{
    public class ServiceStackAprender : ServiceBase<StackAprender>, IServiceStackAprender
    {
        ...
        public ServiceStackAprender(IRepositoryProfessional repositoryProfessional, IMapper mapper)
            : base(repositoryProfessional)
        {
            _repositoryProfessional = repositoryProfessional;
            _mapper = mapper;
        }
        public StackAprender GetById(int Id)
        {
            throw new System.NotImplementedException();
        }

        List<StackAprender> IServiceStackAprender.GetAll()
        {
            throw new System.NotImplementedException();
        }
